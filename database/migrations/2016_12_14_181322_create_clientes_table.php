...
class CreateClientesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('clientes', function (Blueprint $table) {
            ...
            $table->integer('ref1telefono_cliente');
            $table->integer('ref1celular_cliente');
            $table->string('ref2nombre_cliente', 100);
            $table->string('ref2parentesco_cliente',50);
            $table->integer('ref2telefono_cliente');
            $table->integer('ref2celular_cliente');
            $table->string('ref1per_nombre_cliente', 100);
            $table->integer('ref1per_telefono_cliente');
            $table->integer('ref1per_celular_cliente');
            $table->string('ref2per_nombre_cliente', 100);
            $table->integer('ref2per_telefono_cliente');
            $table->integer('ref2per_celular_cliente');           
            $table->string('tcontrato_cliente',1);
            $table->string('saludoper_cliente', 150);
            $table->string('plazo_cliente');
            $table->integer('fechain_cliente')-> unsigned();
            $table->timestamps();
        });
    }
